...
<div class="row">
    <div class="col-lg-8">
        <h2>Объект 3</h2><br>
        <p>Срок выполнения 20.12.2018 - 13.02.2019.</p><br>
        <p><b>Актуальная версия:</b> Изменение №3 от "Дата изменения".</p><br>
        <p>Экспертиза: Планируемая дата захода в экспертизу - 20.02.2019</p><br>
    </div>
    <div class="col-lg-4">
                            ...
                            <br>
                                <div class="box">
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <label class ="" for="">Невыполненная задача 4</label>
                                        </div>
                                    </div>
                    ...
                    <br>
                        <div class="box">
                            <div>
                                ...
                                <div class="form-group">
                                    <input type="checkbox" id="task" value=0 >
                                    <label class ="" for="">Задача 4</label>
                                </div>
