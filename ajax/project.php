...
require_once('../core/connectstyles.php');
 ...
 <div class="showon">\
    <div class="col-lg-8">\
        ...
        <br>\
        C <b>10.11.18<b> ПО <b>12.12.18<b></p>\
        <br>\
 ...
 <div class="showon">\
    ...
    <p>Срок выполнения работ по разделу\
    <br>\
    C <b>12.09.18<b> ПО <b>15.01.19<b></p>\
    <br>\
    <p>Задачи по разделу: </p>\
    </div>\
    <div class="col-lg-4">\
...
<div class="showon">\
    ...
    <p>Срок выполнения работ по разделу\
    <br>\
    C <b>15.12.18<b> ПО <b>13.02.19<b></p>\
    <br>\
    <p>Задачи по разделу: </p>\
    </div>\
    <div class="col-lg-4">\
...
<div class="col-lg-4">\
<span type="submit" id="submit" class="btn btn-info" disabled>В Экспертизу</span>\
...
<div class="col-lg-4">\
<span type="submit" id="submit" class="btn btn-info" >В Экспертизу</span>\
<span type="submit" id="submit" class="btn btn-info">Новое Изменение</span>\
</div>\
<div class="col-lg-8">\
   <div class="panel-group" id="accordion1">\
            ...
            <div class="panel-body">
                <div class="list-group">
                    <a href="#" id="object1" class="list-group-item">
                        ...
                        <span class="pull-right text-muted small"><em>Готовность 0% Срок: до 12.12.18</em></span>
                    </a>
                    <a href="#" id="object2" class="list-group-item">
                        <i class="fa fa-folder fa-fw"></i> Объект 2
                        <span class="pull-right text-muted small"><em>Готовность 100% Срок: до 15.01.19</em></span>
                    </a>
                    <a href="#" id="object3" class="list-group-item">
                        <i class="fa fa-folder fa-fw"></i> Объект 3
                        <span class="pull-right text-muted small"><em>Готовность 50% Срок: до 13.02.19</em></span>
                    </a>
                </div>
                <!-- /.list-group -->
